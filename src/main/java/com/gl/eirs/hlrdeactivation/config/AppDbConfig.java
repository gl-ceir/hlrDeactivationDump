...
@EnableJpaRepositories(
        basePackages = {"com.gl.eirs.hlrdeactivation.repository.app"},
        entityManagerFactoryRef = "springEntityManagerFactory",
        transactionManagerRef = "springTransactionManager")
@EntityScan({"com.gl.eirs.hlrdeactivation.entity.app"})
public class AppDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean appEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.gl.eirs.hlrdeactivation.entity.app")
